...
public:
	...
	bool  isUp()        const { return isUpPress; };
	bool  isLeft()      const { return isLeftPress; };
	bool  isRight()     const { return isRightPress; };
	bool isSpace()     const { return isSpacePress; };
	bool isEnd()		  const { return isEndPress; };
	bool isEsc()		  const { return isEscPress; };
	bool isOne()	      const { return isOnePress; };
	bool isTwo()		  const { return isTwoPress; };
	bool isThree()     const { return isThreePress; };
...
private:
	...
	static bool  isUpPress;            //    "   up         "
	static bool  isLeftPress;          //    "   left       "
	static bool  isRightPress;         //    "   right      "
	static bool isSpacePress;         //    "   space      "
	static bool isEndPress;			 //    "   end		  "
	static bool isEscPress;			 //    "   esc        "
	static bool isOnePress;			 //    "   one        "
	static bool isTwoPress;			 //    "   two        "
	static bool isThreePress;	     //    "   three      "
};
